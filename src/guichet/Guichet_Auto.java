...
public class Guichet_Auto {
	...
	public Guichet_Auto( Compte compte ) {
		...
		JLabel monlabel=new JLabel("Num�ro compte:" + this.compte.getNumero()+ "   Titulaire du compte: " + this.compte.getNom() + "        T�l�phone :" + this.compte.getNumeroTel(),icon,JLabel.CENTER );
		monlabel.setVerticalTextPosition(JLabel.BOTTOM);
		monlabel.setHorizontalTextPosition(JLabel.CENTER);
		panneauNom.add(monlabel);
		
		//panneauNom.add( new JLabel( "Titulaire du compte: " + this.compte.getNom() + "        T�l�phone :" + this.compte.getNumeroTel() ));
